    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div class="d2-theme-header" :style="{ opacity: this.searchActive ? 0.5 : 1 }" flex-box="0" flex>
        ...
        <div class="d2-header-right" flex-box="0">
          ...
          <d2-header-search v-if=false @click="handleSearchClick"/>
          <d2-header-log v-if=false />
          <d2-header-fullscreen v-if=false />
          <d2-header-theme v-if=false />
          <d2-header-size v-if=false />
          <d2-header-locales v-if=false />
          <d2-header-color v-if=false />
          <d2-header-user/>
        </div>
      </div>
      <!-- 下面 主体 -->
